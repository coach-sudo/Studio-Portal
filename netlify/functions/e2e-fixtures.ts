...
async function setup(
  ...
  const services = [
    {
      ...
      deposit_type: "full",
      capacity: 1,
      default_location: "google_meet",
      location_options: ["google_meet"],
    ...
    },
    {
      ...
      capacity: 1,
      default_location: "google_meet",
      location_options: ["google_meet", "in_person"],
  ...
  const { error: packageDefinitionError } = await db
    ...
    .upsert({
      ...
      discount_basis_points: 1250,
      expiration_days: 90,
      recurring_eligible: true,
      benefit_text: "Includes a coach-authored E2E package benefit.",
      visibility: "public",
      active: true,
